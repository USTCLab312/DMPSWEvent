...
//-------------------------------------------------------------------
void DmpEvtHeader::AddFeeErrorTag(const short &id,const short &FeeID,const short &type){
...
//-------------------------------------------------------------------
short DmpEvtHeader::GetTrigger(const short &id) const{
  short v = -1;
  if(TriggersMatch(id)){
...
bool DmpEvtHeader::RunModesMatch(const short &id)const{
